...
!define PRODUCT_WEB_SITE "http://crashfixsoftware.com"
...
!define MUI_FINISHPAGE_SHOWREADME "http://crashfixsoftware.com/index.php/site/page?view=faq#install_win32"     
...
Section "CrashFix Service"
  ...
  ${CreateShortCut} "$SMPROGRAMS\${PRODUCT_NAME}\Online Documentation.lnk" "http://crashfixsoftware.com/index.php/site/page?view=documentation" "" "" ""
